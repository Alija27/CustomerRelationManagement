...
@section('main')
    <div class="top-0 w-full bg-white border border-gray-200 shadow-md ">
        <div class="flex justify-between mb-6 border-b border-gray-200">
            <span class="m-1 mx-4 my-4 text-2xl font-bold">Create Expenditure</span>
        ...
        <form class="w-11/12 p-6 m-6 bg-white rounded-md" method="POST" action={{ route('expenditures.store') }}>
            @csrf
            <div class="mb-6">
