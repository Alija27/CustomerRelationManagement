...
<body class="font-sans antialiased ">
    <div class="h-screen">
        <div class="grid p-20 bg-indigo-600 border-2 md:grid-cols-2 border-slate-700">
            <div class="flex items-center justify-center w-full bg-white border-shadow-md rounded-2xl">
                <div class="w-full">
