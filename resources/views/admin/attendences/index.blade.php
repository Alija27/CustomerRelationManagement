...
@endif
      <div  class="w-full overflow-auto bg-white border border-gray-200 shadow-md">
          <div class="flex justify-between mb-6 border-b border-gray-200">
              <span class="m-1 mx-4 my-4 text-2xl font-bold">Admin Attendences</span>
      ...
      <td class="text-sm font-medium text-gray-900 whitespace-nowrap">
        {{$user->role}}
         ...
         <td class="text-sm font-medium whitespace-nowrap">
             <a href="{{route('admin.attendence.show',$user->id)}}" ><span  class="p-1 px-2 mr-2 text-white bg-green-800 rounded cursor-pointer">  <i class="fa-solid fa-eye"></i></span></a> 
         </td>
