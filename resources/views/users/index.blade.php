      ...
      <div  class="w-full overflow-auto bg-white border border-gray-200 shadow-md">
        ...
        <td class="text-sm font-medium text-gray-900 whitespace-nowrap">
         ...
         <td class="text-sm font-medium whitespace-nowrap">
            <a href="{{route('users.edit',$user)}}"> <span class="p-1 px-2 mr-2 text-white bg-blue-800 rounded">   <i class="fa-solid fa-pen-to-square"></i> </span></a>
             <span onclick="show({{$user->id}})" class="p-1 px-2 mr-2 text-white bg-red-800 rounded cursor-pointer">  <i class="fa-solid fa-trash"></i></a> </span>
             <a href="{{route('users.show', $user->id)}}" ><span  class="p-1 px-2 mr-2 text-white bg-green-800 rounded cursor-pointer">  <i class="fa-solid fa-eye"></i></span></a> 
         </td>
