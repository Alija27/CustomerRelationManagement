            ...
            <div class="lg:w-11/12">
                ...
                <div class="justify-between my-6 lg:flex">
                    ...
                    <div class="flex mx-6 mt-6 lg:mt-0">
                        ...
                        @csrf
                        <button onclick="show()" class="p-2 px-6 mr-2 text-white bg-indigo-600 rounded hover:bg-green-600 "><i
                                class="fa-solid fa-stopwatch"></i><i class="m-1 fa-solid fa-arrow-right"></i>Clock In</button>
                        {{-- </form> --}}
                        <button onclick="out()" class="p-2 px-6 ml-2 text-white bg-indigo-600 rounded hover:bg-red-600"><i
                ...
                <div class="flex flex-wrap gap-6  mx-6 justify-center{{-- justify-center gap-6 m-6 mt-6 lg:flex-nowrap sm:flex-row lg:w-8/12 lg:justify-start lg:gap-4 --}}">
                    ...
                    <div
                        class="flex w-11/12 h-20 p-2 bg-white border-red-100 rounded-md shadow-xl md:w-5/12{{-- lg:w-1/4 --}} ">
