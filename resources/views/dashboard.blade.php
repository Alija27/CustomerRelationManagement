...
<div>
    ...
    <div class="flex mx-6 mt-6 lg:mt-0">
        ...
        {{-- </form> --}}
        <button  class="p-2 px-6 ml-2 text-white bg-indigo-600 rounded hover:bg-red-600"><i class="fa-solid fa-arrow-left"><i class="m-1 fa-solid fa-stopwatch"></i></i>Clock Out</button>
